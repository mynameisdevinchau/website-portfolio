function HeroSection() {
  return (
    <section className="min-h-screen flex items-center justify-between gap-8 px-12 bg-pink-200">
      {/* keeping color at bg-pink-200 to change to a grainy, beige background*/}
